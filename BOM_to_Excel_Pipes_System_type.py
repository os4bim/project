...
#Création automatique d'un bordereau de prix pour tuyauterie.
...
#Le paramètre d'instance code_cir est remplacé par le paramètre d'instance RBS_PIPING_SYSTEM_TYPE_PARAM (System type)
#ou par le paramètre de votre choix

#Shared parameter FMF_Angle #Valeur à changer selon vos familles de fitting
...
for PA in PAs:
	...
	# System type - Instance Parameter (Je laisse le nom code_circuit à titre d'exemple mais vous pourrrez trouver un nom approprié à votre code)
	code_circuit = PA.get_Parameter(
					BuiltInParameter.RBS_PIPING_SYSTEM_TYPE_PARAM)
	PA_code_circuit.append(code_circuit.AsValueString())
...
for PI in PIs:
	...
	# System type - Instance Parameter (idem ligne 47)
	code_circuit = PI.get_Parameter(
					BuiltInParameter.RBS_PIPING_SYSTEM_TYPE_PARAM)
	PI_code_circuit.append(code_circuit.AsValueString())
...
for PF in PFs:
	...
	# System type - Instance Parameter (idem ligne 47)
	code_circuit = PF.get_Parameter(
					BuiltInParameter.RBS_PIPING_SYSTEM_TYPE_PARAM)
	PF_code_circuit.append(code_circuit.AsValueString())
